...
\title{\centering{Semiconductors in equilibrium}}
\author{Thorbjørn Erik Køppen Christensen}


\begin{document}
\maketitle
\titleblock[bodyoffsety=1cm,titleoffsety=1cm]{Intrinsic semiconductors}
\begin{columns}
        \column{0.5} 
        \block{Equilibrium distributions}{
\begin{wrapfigure}{r}{10cm}\foldfig{width=10cm}{band_gap_schematic}\end{wrapfigure}
The equilibrium distributions are:
\begin{align*}
        n(E)&=g_c(E)f_{F}(E)\\
        p(E)&=g_v(E)(1-f_F(E))\\
\end{align*}
with $f_F$ being a Fermi--Dirac distribution
...
An intrinsic semiconductor is a perfect and perfectly pure semiconductor crystal. At $T=0k$ all states in the valence band is filled.
        ...
        \begin{subcolumns}
                \subcolumn{0.56}
        \block{Intrinsic carrier concentration}{
...
\end{align*}
        ...
        \end{subcolumns}
        \phantom{\block[bodyoffsety=7cm,titleoffsety=7cm]{hej}{}}
        \column{0.5} 
        \block{Thermal equilibrium electron distribution}{
...
\end{columns}
\titleblock{Extrinsic semiconductors}
\begin{columns}
        \column{0.5} 

        \block{Probability function}{
\begin{align*}
...
\end{align*}}
        ...
        \block{Dopant atoms}{
                ...
                \begin{wrapfigure}{r}{10cm}\foldfig{width=10cm}{doner_acceptor}\end{wrapfigure}

                Donors and acceptors change the properties, it also makes the semiconductor extrinsic instead of intrinsic.\vspace{1.5cm}}

        \block{Extrinsic semiconductor}{

                \begin{wrapfigure}{r}{19cm}\foldfig{width=19cm}{extrinsic_semiconductor}\end{wrapfigure}
...
\begin{align*}
        ...
        &=n_i^2
\end{align*}}
        \block{Thermal equilibrium electron concentration}{
A compensated semiconductor has both acceptor and donor impurities
\begin{align*}
        n_0+N_a^-&=p_0+N_d^+= n_0+(N_a-p_a)=p_0+(N_d-n_d)\\
