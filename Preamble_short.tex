\documentclass[subcolspace=1mm,colspace=0.5cm,blockverticalspace=1cm]{tikzposter}
...
\newcommand{\titleblock}[2][]{\useblockstyle{Justtitle}\block[bodyinnersep=-0.4cm,#1]{#2}{}\useblockstyle{Default}}
