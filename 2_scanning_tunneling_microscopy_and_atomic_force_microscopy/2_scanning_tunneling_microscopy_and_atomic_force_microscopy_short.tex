...
\begin{columns}
        \column{0.4}
        \block[bodyoffsety=2cm,titleoffsety=2cm]{principle}{\foldfig{width=13cm}{stm_setup}\foldfig{width=17cm}{stm_bias_tunneling}}
        ...
        \column{0.6}
        \block[bodyoffsety=2cm,titleoffsety=2cm]{Tunneling math!!!}{
        \begin{align*}
...
\begin{columns}
        \column{0.5} 
        \block[bodyoffsety=2cm,titleoffsety=2cm]{setup}{\foldfig{}{afm_setup}
\foldfig{}{afm_leonard_jones}
        ...
        \column{0.5}
        \block[bodyoffsety=2cm,titleoffsety=2cm]{Cantilever mechanics}{
% \begin{align*}
